---
name: dhf-weibo-video-publish-task
description: 调用 DHF Agent 任务自动发布视频到微博平台。支持内容、视频路径配置
version: 1.0.0
metadata:
  tags: [dhf, weibo, publish, video, automation]
...
```bash
# 基本发布
/dhf-weibo-video-publish-task --content "hello！" --video "./video.mp4"

# 多个视频
/dhf-weibo-video-publish-task --content "内容" --video "./v1.mp4" --video "./v2.mp4"

# 保存草稿
/dhf-weibo-video-publish-task --content "内容" --video "./video.mp4" --autoSend "N"

# 检查 DHF Agent 连接
/dhf-weibo-video-publish-task --check
```
