---
name: dhf-douyin-video-publish-task
description: 调用 DHF Agent 任务自动发布视频到抖音平台。支持标题、内容、视频路径配置
version: 1.0.0
metadata:
  tags: [dhf, douyin, publish, video, automation]
...
```bash
# 基本发布
/dhf-douyin-video-publish-task --title "hello" --content "hello!" --video "./video.mp4"

# 多个视频
/dhf-douyin-video-publish-task --title "标题" --content "内容" --video "./v1.mp4" --video "./v2.mp4"

# 保存草稿
/dhf-douyin-video-publish-task --title "标题" --content "内容" --video "./video.mp4" --autoSend "N"

# 检查 DHF Agent 连接
/dhf-douyin-video-publish-task --check
```
