---
name: dhf-zhihu-video-publish-task
description: 调用 DHF Agent 任务自动发布视频笔记到知乎平台。支持标题、内容、视频路径配置
version: 1.0.0
metadata:
  tags: [dhf, zhihu, publish, video, automation]
...
```bash
# 基本发布
/dhf-zhihu-video-publish-task --title "标题" --content "内容" --video "./video.mp4"

# 多个视频
/dhf-zhihu-video-publish-task --title "标题" --content "内容" --video "./v1.mp4" --video "./v2.mp4"

# 保存草稿
/dhf-zhihu-video-publish-task --title "标题" --content "内容" --video "./video.mp4" --autoSend "N"

# 检查 DHF Agent 连接
/dhf-zhihu-video-publish-task --check
```
